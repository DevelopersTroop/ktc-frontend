...
const CustomwheelsFrontAttributes = ({
  cartProduct,
}: {
  ...
  return (
    <div className="relative flex items-center gap-2">
      {cartProduct?.metaData?.frontDiameter &&
        cartProduct?.metaData?.frontWidth && (
          <div className="relative flex flex-col items-start justify-center gap-2 rounded-md border border-[#cfcfcf] px-3 py-2">
            ...
            <p className="text-base leading-[19px] text-[#210203]">
              <span className="text-base font-semibold text-[#210203]">
                {cartProduct?.metaData?.frontDiameter} x{" "}
                {cartProduct?.metaData?.frontWidth}
              </span>
            </p>
          </div>
...
export default CustomwheelsFrontAttributes;
