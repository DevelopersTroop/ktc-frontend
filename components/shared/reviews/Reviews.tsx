        ...
        <div className='space-y-2'>
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>
                            <h2 className='text-xl font-semibold border-b py-1'>Write your review</h2>
                        </DialogTitle>
                    </DialogHeader>
                                    ...
                                    <div className="space-y-xs pl-[2rem] ">
                                        ...
                                        <div className="flex space-x-3 items-center">
                                            <div className="w-[3.5rem] flex items-center gap-1">
                                                <h3 className="text-[1.5rem] font-semibold text-muted">5</h3>
                                                <StarIcon size={20} className='fill-[#ffc107] stroke-[#ffc107] text-xl' />
                                            </div>
                                            <div className='relative w-full'>
                                                <div className={`bg-[#FFC107] ${getPercentage[5]} h-4  absolute z-20 top-1/2 -translate-y-1/2 left-0`} />
                                                <div className={`bg-gray-400 w-full h-4  absolute top-1/2 -translate-y-1/2 left-0 z-10`} />
                                            </div>
                                            <div>
                                        ...
                                        <div className="flex space-x-3 items-center">
                                            <div className="w-[3.5rem] flex items-center gap-1">
                                                <h3 className="text-[1.5rem] font-semibold text-muted">4</h3>
                                                <StarIcon size={20} className='fill-[#ffc107] stroke-[#ffc107] text-xl' />
                                            </div>
                                            <div className='relative w-full'>
                                                <div className={`bg-[#FFC107] ${getPercentage[4]} h-4  absolute z-20 top-1/2 -translate-y-1/2 left-0`} />
                                                <div className={`bg-gray-400 w-full h-4  absolute top-1/2 -translate-y-1/2 left-0 z-10`} />
                                            </div>
                                            <div>
                                        ...
                                        <div className="flex space-x-3 items-center">
                                            <div className="w-[3.5rem] flex items-center gap-1">
                                                <h3 className="text-[1.5rem] font-semibold text-muted">3</h3>
                                                <StarIcon size={20} className='fill-[#ffc107] stroke-[#ffc107] text-xl' />
                                            </div>
                                            <div className='relative w-full'>
                                                <div className={`bg-[#FFC107] ${getPercentage[3]} h-4  absolute z-20 top-1/2 -translate-y-1/2 left-0`} />
                                                <div className={`bg-gray-400 w-full h-4  absolute top-1/2 -translate-y-1/2 left-0 z-10`} />
                                            </div>
                                            <div>
                                        ...
                                        <div className="flex space-x-3 items-center">
                                            <div className="w-[3.5rem] flex items-center gap-1">
                                                <h3 className="text-[1.5rem] font-semibold text-muted">2</h3>
                                                <StarIcon size={20} className='fill-[#ffc107] stroke-[#ffc107] text-xl' />
                                            </div>
                                            <div className='relative w-full'>
                                                <div className={`bg-[#FFC107] ${getPercentage[2]} h-4  absolute z-20 top-1/2 -translate-y-1/2 left-0`} />
                                                <div className={`bg-gray-400 w-full h-4  absolute top-1/2 -translate-y-1/2 left-0 z-10`} />
                                            </div>
                                            <div>
                                        ...
                                        <div className="flex space-x-3 items-center">
                                            <div className="w-[3.5rem] flex items-center gap-1">
                                                <h3 className="text-[1.5rem] font-semibold text-muted">1</h3>
                                                <StarIcon size={20} className='fill-[#ffc107] stroke-[#ffc107] text-xl' />
                                            </div>
                                            <div className='relative w-full'>
                                                <div className={`bg-[#FFC107] ${getPercentage[1]} h-4  absolute z-20 top-1/2 -translate-y-1/2 left-0`} />
                                                <div className={`bg-gray-400 w-full h-4  absolute top-1/2 -translate-y-1/2 left-0 z-10`} />
                                            </div>
                                            <div>
                                        ...
                                        <div className='w-full mt-2'>
                                            <Button onClick={()=>setOpen(true)} className='w-full rounded-none bg-white text-black border shadow-none'>Write a review</Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
