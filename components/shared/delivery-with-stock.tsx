const DeliveryWithStock = () => {
  return (
    <div className="relative flex w-full flex-1 flex-col items-start gap-3 pl-0 pr-5 md:items-end">
      <div className="relative flex items-center gap-1">
        ...
        <p className="text-base leading-[19px] text-[#210203]">
          <span className="text-base font-normal text-[#210203]">In Stock</span>
        </p>
      </div>
