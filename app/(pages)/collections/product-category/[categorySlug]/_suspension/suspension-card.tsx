...
import SuspensionCardDescription from "./suspension-card-description";

const SuspensionCard = ({ product }: { product: TInventoryItem }) => {
  ...
  return (
    ...
    >
      <Link className="inline-block" href={productLink}>
        ...
        <SuspensionCardDescription product={product} />
      </Link>
    </div>
  );
};
