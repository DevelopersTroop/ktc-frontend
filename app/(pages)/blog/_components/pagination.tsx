    ...
    <div className="flex flex-wrap justify-center items-center gap-2 py-8">
      ...
      <Link 
        ...
        className={`flex items-center justify-center w-10 h-10 rounded-full border ${
          page <= 1 ? "text-gray-300 border-gray-200 cursor-not-allowed" : "text-gray-700 border-gray-300 hover:bg-gray-100"
        }`}
      ...
      <Link 
        ...
        className={`flex items-center justify-center w-10 h-10 rounded-full border ${
          page >= pages ? "text-gray-300 border-gray-200 cursor-not-allowed" : "text-gray-700 border-gray-300 hover:bg-gray-100"
        }`}
