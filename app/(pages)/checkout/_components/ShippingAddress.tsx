...
const ShippingAddressForm = () => {
  ...
  return (
    <div className="grid grid-cols-12">
      <form
        className="col-span-12 flex max-w-xl flex-col gap-y-8 md:col-span-7 lg:col-span-8"
      ...
      >
        ...
        <div className="flex flex-col gap-y-8">
          ...
          {!user?._id && !isAccountCreated ? (
            <div>
              <div className="flex items-start gap-2">
                <Checkbox
                  id="createAccount"
                  checked={createAccount}
                  className="mt-1 h-5 w-5 border-black data-[state=checked]:bg-black"
                  onCheckedChange={handleCreateAccountChange}
                />
                <Label
                  htmlFor="createAccount"
                  className="mb-2 cursor-pointer space-y-2"
                >
