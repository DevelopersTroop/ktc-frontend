...
export const SelectAmaniDealerWithoutDiscount: React.FC<{
  checked: boolean;
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        {showSubtitle ? <p>with free mount balance and installation</p> : ""}
        <button className="flex items-center gap-2 font-semibold">
          ...
          <span onClick={relocateMap} className="underline">
            See on the map
          </span>
        </button>
      </div>
      ...
      <div className="py-sm space-y-3">
        <div className="flex flex-col items-start justify-between">
          <div className="max-w-lg space-y-1">
            ...
            <h2 className="text-2xl font-bold lg:text-[2rem]">$0.00*</h2>
          </div>
          <div className="whitespace-nowrap rounded-md py-2 text-lg">
            {subtitle ? subtitle : "Include free mount, balance, install"}
          </div>
          <p className="text-[14px] text-muted">
            Basic installation price calculated for tires and wheels only.
            Premium services may incur additional fees. Please contact installer
            for installation price related to brakes, suspension, and other
