...
import FinancingHero1 from "./_components/financing-hero1";
      ...
      <div className="w-full flex flex-col gap-8 pt-6 pb-20 sm:pb-40">
        ...
        <div className="w-full flex flex-col gap-4 text-start sm:text-center">
          ...
          <p className="text-lg font-normal text-[#210203] max-w-[752px] m-auto hidden sm:block">
            Quality wheels and tires are an investment in your vehicle's safety
            ...
            dedicated to making sure you don't have to compromise on quality.
          ...
          <p className="text-lg font-normal text-[#210203] max-w-[752px] m-auto sm:hidden">
            ...
            <span className="block pt-4 ">
              ...
              we’re dedicated to making sure you don't have to compromise on
        ...
        <div className="w-full max-w-[384px] text-center m-auto">
          <Link href={"/collections/product-category/in-stock-wheels"}>
            <button className="rounded-xl px-6 w-full flex flex-1 gap-2 justify-center items-center relative h-14 bg-primary hover:bg-red-700 text-white hover:text-white transition duration-300 ease-in-out">
