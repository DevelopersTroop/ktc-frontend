...
const StickyVehicleSelector = () => {
  ...
  return (
    <>
      ...
      <div
        ref={selectorRef}
        className={`hidden md:block bg-gray-800 transition-all duration-300 z-20 fixed top-0 left-0 right-0 shadow-lg ${
          isVisible
      ...
      {/* Mobile View */}
      <div
        className={`md:hidden bg-gray-800 transition-all duration-300 z-50 fixed top-0 left-0 right-0 shadow-lg ${
          isVisible
      ...
      >
        <div className="flex">
          ...
          <button
            ...
            className="flex-1 bg-gray-700 text-white px-4 py-4 flex items-center justify-between text-sm font-medium"
          >
